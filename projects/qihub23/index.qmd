...
date: 2-7-2024
categories: [Public Health, SDOH, Diabetes] # self-defined categories
citation: 
  url: https://shelbylevel.org/projects/qihub23 
...
readxl::read_excel(
  '/Users/shelbylevel/Documents/github/qihub23/codebooks/SDOH_2020_Codebook_1_0.xlsx',
  sheet = 4
) %>%
  select(
    1:5
...
county_sdoh_chr %>%
  ...
  labs(fill = "Percent", caption = "Source: County Health Rankings (2020)")
```
...
#ggsave('projects/qihub23/preview-image.png')
```
