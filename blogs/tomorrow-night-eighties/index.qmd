...
#| echo: false
#| message: false
source(here::here("blogs", "tomorrow-night-eighties", "R", "pluck_colors.R"))
```
...
#| echo: false
#| warning: false
tne_original_tokencolors3 |>
  dplyr::mutate(color = add_colour_dots(color)) |>
